...
Class Engine3d
  ...
  Public Overrides Function OnUserCreate() As Boolean
    ...
    ' Load object file
    m_meshCube.LoadFromObjectFile("assets/mountains.obj")
  ...
  Public Overrides Function OnUserUpdate(elapsedTime As Single) As Boolean
    ...
    ' Clear Screen
    Fill(0, 0, ScreenWidth(), ScreenHeight(), Solid, FgBlack)
    ...
    For Each triToRaster In trianglesToRaster
      ...
      For Each t In listTriangles
        ...
        'DrawTriangle(t.P(0).X, t.P(0).Y, t.P(1).X, t.P(1).Y, t.P(2).X, t.P(2).Y, SOLID, FG_BLACK);
      Next
  ...
  Private Shared Function GetColour(lum As Single) As CHAR_INFO
    ...
    Select Case pixelBw
      ...
      Case 12 : bgCol = BgGray : fgCol = FgWhite : sym = Solid
        'Case Else : bg_col = BG_BLACK : fg_col = FG_BLACK : sym = SOLID
      Case Else : bgCol = BgWhite : fgCol = FgWhite : sym = Solid
    End Select
