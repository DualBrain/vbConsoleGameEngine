...
Class Asteroids
  ...
  Public Overrides Function OnUserUpdate(elapsedTime As Single) As Boolean
    ...
    For Each a In m_asteroids
      ...
      DrawWireFrameModel(m_modelAstroid, a.X, a.Y, a.Angle, a.Size, FgYellow)
    Next
...
#End Region
  ...
  Private Sub ResetGame()
    ...
    m_player = New SpaceObject With {.X = ScreenWidth() \ 2,
                                     .Y = ScreenHeight() \ 2,
                                     .Dx = 0,
                                     .Dy = 0,
                                     .Angle = 0.0}
  ...
  'Private Sub DrawWireFrameModel(vecModelCoordinates As List(Of (X As Double, Y As Double)), x As Single, y As Single, Optional ByVal r As Double = 0.0F, Optional s As Double = 1.0F, Optional col As Integer = FgWHITE)
  ...
  '             transformedCoordinates(j).X, transformedCoordinates(j).Y, SOLID, col)
  '  Next
